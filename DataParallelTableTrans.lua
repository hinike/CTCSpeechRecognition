...
local ThreadsImplCTC = torch.class('nn.DataParallelTableTrans.Threads', 'nn.DataParallelTable.Threads')
...
function DataParallelTableTrans:threads(initFunc)
   require 'threads'
   self.impl:close()
   self.impl = nn.DataParallelTableTrans.Threads(self, initFunc)
   return self
end
